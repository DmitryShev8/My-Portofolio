  ...
  return (
    <Layout>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-16 py-20 grid md:grid-cols-12 gap-8 items-center">
        <div className="md:col-span-7 space-y-6">
          ...
          <h1 className="font-headline-xl text-5xl md:text-6xl text-balance">
            Analysing <span className="text-primary italic">Data</span> with the
            Precision of an <span className="text-primary">Artisan</span>.
          </h1>
      ...
      "
          ...
          {/* Space supaya badge tidak menimpa card */}
          ...
          <div className="bg-surface-container-low border border-outline-variant rounded-xl p-6">
            ...
            <p className="text-sm text-on-surface-variant mb-5">
              Transform my portrait using AI. Describe any style you'd like.
            </p>

            <textarea
              value={prompt}
              onChange={(e) => setPrompt(e.target.value)}
              placeholder="e.g. Turn him into an astronaut..."
              className="w-full h-28 rounded-lg bg-surface border border-outline-variant p-4 resize-none focus:outline-none focus:border-primary"
            />

            <button
              onClick={handleGenerate}
              disabled={loading}
              className="mt-4 w-full bg-primary text-black py-3 rounded-lg font-medium hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <section className="bg-surface-container-lowest py-24 border-y border-outline-variant">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            <div>
              <h2 className="font-headline-lg text-4xl">Academic Foundation</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-surface-container-low border border-outline-variant p-8 rounded-xl flex flex-col">
              ...
              <p className="mt-4 text-sm text-on-surface-variant">
                Intensive training in SQL, Python, Statistics, Machine Learning,
                and Power BI through real-world business case studies.
              </p>
