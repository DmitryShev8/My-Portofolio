  ...
  return (
    <div className="bg-background text-on-background min-h-screen">
      ...
      <main className="pt-24">
        ...
        {nextBook && (
          <section className="max-w-4xl mx-auto px-6 border-t border-outline-variant pt-12">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              <button
                onClick={() => navigate("/reading-list")}
                className="flex items-center gap-2 text-primary hover:-translate-x-1 transition"
              >
              ...
              <div className="text-center md:text-right">
                <p className="uppercase text-sm text-on-surface-variant mb-2">
                  Read Next
                </p>
                ...
                <button
                  ...
                  className="group"
                >
                  <h3 className="font-headline-md text-headline-md group-hover:text-primary transition">
                    {nextBook.title}
                  </h3>
